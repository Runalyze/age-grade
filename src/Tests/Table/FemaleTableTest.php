...
class FemaleTableTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->assertEquals(0.9573, round($this->Table->getAgePerformance(15, 5.0, 16 * 60 + 10), 4));
        $this->assertEquals(0.7587, round($this->Table->getAgePerformance(27, 10.0, 39 * 60 + 10), 4));
        $this->assertEquals(0.8434, round($this->Table->getAgePerformance(42, 42.2, 2 * 60 * 60 + 45 * 60 + 0), 4));
        $this->assertEquals(0.4212, round($this->Table->getAgePerformance(54, 10.0, 1 * 60 * 60 + 23 * 60 + 45), 4));
    }
    ...
    public function testSomeOpenStandardValues()
    {
        ...
        $this->assertEquals(8044.0, $this->Table->getAgeStandard(25, 42.195));
